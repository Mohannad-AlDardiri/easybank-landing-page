...
const Footer = () => {
  return (
    <footer className="lg:flex">
      <div className="footer-links sm:flex-row">
        <div className="sm:mb-4 lg:mb-0 " style={{flexBasis: '33.3333%'}}>
          <svg
          ...
          <ul className="social-icons" >
            <li>
              <Link to="easybank-landing-page/facebook_icon" aria-label="facebook">
            ...
            <li>
              <Link to="easybank-landing-page/youtube_icon" aria-label="youtube">
            ...
            <li>
              <Link to="easybank-landing-page/twitter_icon" aria-label="twitter">
            ...
            <li>
              <Link to="easybank-landing-page/pinterest_icon" aria-label="pinterest">
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20">
                  <path
                    fill="#FFF"
            ...
            <li>
              <Link to="easybank-landing-page/instagaram_icon" aria-label="instagaram">
                <svg xmlns="http://www.w3.org/2000/svg" width="21" height="20">
                  <path
                    fill="#FFF"
        ...
        <div className="footer-links-container sm:flex-row">
          <div className="first-footer-links ">
            <ul className="pb-0 sm:pt-2 ">
              <li>
                {/* eslint-disable-next-line jsx-a11y/anchor-has-content */}
                {/* make the text in the a not the href */}
                <Link to="easybank-landing-page/About-Us">About Us</Link>
              </li>
              <li>
          ...
          <div className="sec-footer-links ">
            <ul className="sec-footer-ul sm:pt-2 lg:pt-4">
              ...
              <li>
                <Link to="easybank-landing-page/Support">Support</Link>
              </li>
              <li >
                <Link to="easybank-landing-page/Privacy-Policy">Privacy Policy</Link>
              </li>
            </ul>
          </div>
        </div>
      </div>
      <div className="footerbtn-container flex flex-col justify-center w-full">
        {/* hidden md:block p-3 px-7 */}
        <button className="landing-btn footer-btn">Request Invite</button>
